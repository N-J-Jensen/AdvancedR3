...
# Tell Git to ignore the files created in the data-raw/nmr-omics/ folder, as they are stored on Zenodo.
# usethis::use_git_ignore("data-raw/nmr-omics/") - done, only need to do once
